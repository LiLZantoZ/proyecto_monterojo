...
(function () {
    ...
    function htmlRotulo(datos, numero, total, producto) {
        ...
        // en scripts_picking.js y en scripts_rotulos.js) y en el PDF (helper_rotulos_pdf.php,
        // en este mismo módulo): sin logo —no entra en 4cm de alto—, sin etiqueta suelta para
